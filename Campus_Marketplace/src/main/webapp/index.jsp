...
<body>
    ...
    <section class="products" id="productSection">
        <!-- Product 1 -->
        <div class="product">
            <img src="drafterimg.jpg" alt="Drafter" >
        ...
        <!-- Product 2 -->
        <div class="product">
            <img src="calcimg.jpg" alt="Calculator">
            <div class="product-details">
                <h3>Calculator</h3>
        ...
        <div class="product">
           ...
           <div class="product">
            <img src="CompNet.jpg" alt="CompNet">
            <div class="product-details">
            ...
            form.addEventListener("submit", function (event) {
                ...
                xhr.onload = function () {
                    if (xhr.status === 200) {
                        ...
                        // Optionally, update the UI or do something with the response
                    } else {
